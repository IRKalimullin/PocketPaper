...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragmentManager.beginTransaction().add(R.id.main_container, currentTasksFragment).commit()
        ...
        navigationView.setOnNavigationItemSelectedListener(object :
            ...
            override fun onNavigationItemSelected(item: MenuItem): Boolean {
                when (item.itemId) {
                    R.id.bottom_navigation_menu_tasks_button -> fragmentManager.beginTransaction()
                        .replace(R.id.main_container, currentTasksFragment).commit()

                    R.id.bottom_navigation_menu_notes_button -> fragmentManager.beginTransaction()
                        .replace(R.id.main_container, notesListFragment).commit()

                    R.id.bottom_navigation_menu_purchases_button -> fragmentManager.beginTransaction()
                        .replace(R.id.main_container, purchaseFragment).commit()
                }
                return true
            }
